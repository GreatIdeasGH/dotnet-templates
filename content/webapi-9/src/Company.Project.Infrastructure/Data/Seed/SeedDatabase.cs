...
namespace Company.Project.Infrastructure.Data.Seed;
...
public static class SeedDatabase
{
    ...
    public static async Task MigrateDb(IApplicationBuilder builder, IHostEnvironment environment)
    {
        ...
        try
        {
            ...
            if (getUserRole == null)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    [
                        ...
                        new Claim(UserClaims.Permission, AppPermissions.Donor.View),
                        new Claim(UserClaims.Permission, AppPermissions.Donation.View),
                        new Claim(UserClaims.Permission, AppPermissions.Campaign.View),
                        new Claim(UserClaims.Permission, AppPermissions.Dashboard.View),
                        new Claim(UserClaims.Permission, AppPermissions.Settings.View),
                        new Claim(UserClaims.Permission, AppPermissions.Reports.View),
                    ];
            ...
            // Seed Data
            await SeedUsers(context, userManager, environment);
        }
        catch (Exception ex)
        {
            OtelConstants.AddExceptionEvent(
