...
public static class StatusLabels
{
    ...
    public const string UnprocessableUpdateError =
        "Record(s) could not be updated, please try again";
    ...
    public const string UnprocessableDeleteError =
        "Record could not be deleted, it may have related records";
    ...
    public const string ServerErrorRecords =
        "Records could not be retrieved from server, please try again.";
    ...
    public static string MemberMessage(string memberName, string customMessage) =>
        $"Dear {memberName}. {customMessage}";

    public static string BirthdayMessage =>
        "May you find peace and success, happiness and fulfillment, and all that your heart desires. Have a bright and cheerful birthday, and God Bless You!";
